...
export default function StatueTile({ signature }: { signature: Signature }) {
  return (
    <div className="group relative flex items-center justify-center bg-surface hover:bg-border/30 border border-border/60 hover:border-border rounded-card h-[60px] w-[140px] px-sm overflow-hidden transition-colors duration-300 shadow-sm cursor-help">
